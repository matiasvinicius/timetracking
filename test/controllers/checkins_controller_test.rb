...
class CheckinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post checkins_url, params: { checkin: { created_at: @checkin.created_at, latitude: @checkin.latitude, longitude: @checkin.longitude, typeCheckin: @checkin.typeCheckin } }
    end
  ...
  test "should update checkin" do
    patch checkin_url(@checkin), params: { checkin: { created_at: @checkin.created_at, latitude: @checkin.latitude, longitude: @checkin.longitude, typeCheckin: @checkin.typeCheckin } }
